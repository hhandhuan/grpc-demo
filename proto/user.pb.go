...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x05, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x22, 0x20, 0x0a, 0x0e, 0x47, 0x65, 0x74,
	...
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x32, 0x42,
	0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x3a, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x12, 0x15, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
...
var file_proto_user_proto_goTypes = []interface{}{
	(*GetUserRequest)(nil),  // 0: hello.GetUserRequest
	(*GetUserResponse)(nil), // 1: hello.GetUserResponse
}
var file_proto_user_proto_depIdxs = []int32{
	0, // 0: hello.User.GetUser:input_type -> hello.GetUserRequest
	1, // 1: hello.User.GetUser:output_type -> hello.GetUserResponse
...
func (c *userClient) GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hello.User/GetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
